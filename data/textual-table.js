d3.select("#chart3")
  ...
  .html("<h2>Word Cloud</strong></h2> This word cloud highlights the most frequently used words, with larger words appearing more often.</br>");


d3.csv("sentimentdataset_iso3.csv").then(function(data) {
