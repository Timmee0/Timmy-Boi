d3.select("#chart2")
  ...
  .html("<strong>World Map of Social Media Posts</strong><br>Each circle shows the number of social media posts from each country.");
...
// Load data
d3.json("data/world-110m.geojson").then(function(geoData) {
  d3.csv("data/sentimentdataset_iso3.csv").then(function(posts) {
